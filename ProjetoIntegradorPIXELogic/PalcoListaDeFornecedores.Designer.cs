...
{
    partial class PalcoListaDeFornecedores
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            btnExcluir.Location = new Point(746, 6);
            ...
            btnEditar.Location = new Point(715, 6);
            ...
            label4.Location = new Point(305, 12);
            label4.Name = "label4";
            ...
            label5.Location = new Point(400, 13);
            label5.Name = "label5";
            ...
            label6.Location = new Point(513, 12);
            label6.Name = "label6";
            ...
            label7.Location = new Point(630, 13);
            label7.Name = "label7";
            label7.Size = new Size(38, 15);
            label7.TabIndex = 93;
            label7.Text = "label7";
            // 
            // PalcoListaDeFornecedores
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            BackColor = Color.FromArgb(16, 25, 56);
            ClientSize = new Size(782, 36);
            Controls.Add(label7);
            Controls.Add(label6);
            Controls.Add(label5);
            Controls.Add(label4);
            ...
            Text = "PalcoListaDeFornecedores";
            Load += PalcoListaDeFornecedores_Load;
            ResumeLayout(false);
            PerformLayout();
        }
