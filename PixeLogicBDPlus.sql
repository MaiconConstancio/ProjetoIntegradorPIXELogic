...
--
-- Table structure for table `cadastro_nova_conta`
--

DROP TABLE IF EXISTS `cadastro_nova_conta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cadastro_nova_conta` (
...
--
-- Dumping data for table `cadastro_nova_conta`
--

LOCK TABLES `cadastro_nova_conta` WRITE;
/*!40000 ALTER TABLE `cadastro_nova_conta` DISABLE KEYS */;
/*!40000 ALTER TABLE `cadastro_nova_conta` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-09-15 15:39:38
